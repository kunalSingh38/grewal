...
class _SettingsState extends State<SupportOverview> {
  bool _value = false;
  String support_id = "";
  bool _loading = false;
  ...
  Future _getChapterData() async {
    ...
    var response = await http.post(
      new Uri.https(BASE_URL, API_PATH + "/student_support_details"),
      body: {"id": support_id.toString()},
      headers: headers,
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Container(
          child: Text("Support Detail", style: normalText6),
        ),
