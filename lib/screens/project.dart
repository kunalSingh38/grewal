...
class _SettingsState extends State<Project> {
  bool _value = false;
  String chapter_id = "";
  bool _loading = false;
  ...
  Widget htmlList(Size deviceSize) {
    return Container(
      child: SfPdfViewer.network(
        "https://www.grewaleducation.com/admin/public/assets/chapter_images/project1.pdf",
      ),
    );
  }
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Container(
          child: Text("Project", style: normalText6),
        ),
